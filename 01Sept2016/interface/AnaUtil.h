...
namespace AnaUtil {
  ...
  static inline 
  double deltaEta(double etaa, double etab) {
    double deta = fabs(etaa - etab);
    return deta;
  }
  static inline 
  double deltaEta(const TLorentzVector &a, const TLorentzVector& b) {
    return deltaEta(a.Eta(), b.Eta());
  }
  static inline 
