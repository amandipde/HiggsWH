...
vhtm::Electron::Electron():
  ...
  fidFlag(0),
  selbit(0),
  isPassMedium_MVAIDWP90(-999),
  isPassTight_MVAIDWP80(-999),
  mvaId(-999),
  mvaId_def(-999)
{
  idmap.clear();
...
vhtm::Tau::Tau():
  ...
  againstElectronVLooseMVA6(-1),
  againstElectronLooseMVA6(-1),
  againstElectronMediumMVA6(-1),
  againstElectronTightMVA6(-1),
  againstElectronVTightMVA6(-1),
