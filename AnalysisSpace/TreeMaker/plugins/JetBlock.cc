...
void JetBlock::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if (found && jets.isValid()) {
    ...
    for (const pat::Jet& jet: *jets) {
      ...
      jobj.combinedInclusiveSecondaryVertexV2BJetTags 
                                            = jet.bDiscriminator("combinedInclusiveSecondaryVertexV2BJetTags");
      jobj.pfCombinedInclusiveSecondaryVertexV2BJetTags 
