// -*- C++ -*-
//
// Package:    MyFilter/mmtOReetFilter
// Class:      mmtOReetFilter
// 
/**\class mmtOReetFilter mmtOReetFilter.cc MyFilter/mmtOReetFilter/plugins/mmtOReetFilter.cc
...
class mmtOReetFilter : public edm::EDFilter {
   public:
      explicit mmtOReetFilter(const edm::ParameterSet&);
      ~mmtOReetFilter();
...
//
mmtOReetFilter::mmtOReetFilter(const edm::ParameterSet& iConfig)
{
...
bool
mmtOReetFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   // Input pat::Muon
   ...
   std::cout << "Filterting ......" << std::endl;
   if ((muoCount >= 2 || eleCount >=2) && tauCount >= 1) return true;
   else return false;
}

// ------------ method called once each job just before starting event loop  ------------
void 
mmtOReetFilter::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
mmtOReetFilter::endJob() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
mmtOReetFilter::beginRun(edm::Run const&, edm::EventSetup const&)
{ 
}
*/
...
/*
void
mmtOReetFilter::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
mmtOReetFilter::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
mmtOReetFilter::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
mmtOReetFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(mmtOReetFilter);
